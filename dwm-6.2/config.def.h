...
static const char col_purp[] = "#bd93f9";
static const unsigned int baralpha = 0xd0;
static const unsigned int borderalpha = OPAQUE;
static const char *colors[][3] = {
    /*               fg         bg         border   */
    [SchemeNorm] = {col_gray3, col_gray1, col_gray2},
    [SchemeSel] = {col_gray4, col_gray1, col_purp},
};
...
static Key keys[] = {
    ...
    {MODKEY, XK_w, spawn, SHCMD("setxkbmap se -option ctrl:nocaps && xmodmap -e \"keysym Print = Super_L\"")},
    {MODKEY, XK_q, spawn, SHCMD("setxkbmap us -option ctrl:nocaps && xmodmap -e \"keysym Print = Super_L\"")},
